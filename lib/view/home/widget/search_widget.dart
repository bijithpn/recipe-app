          ...
          builder: (context, dark, _) {
            return SearchAnchor.bar(
              ...
              barBackgroundColor: WidgetStateProperty.all(
                  dark ? ColorPalette.blackLight : ColorPalette.white),
              ...
              suggestionsBuilder:
                ...
                final suggestions = _ingredients.where((ingredient) =>
                    ingredient.toLowerCase().startsWith(currentText));
